...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<link rel="stylesheet" href="/xiaoyuanwang/css/css/updPersonInfo.css" type="text/css"></link>
	</head>
	<body>
				...
				<table width="100%">
					<tr>
											...
											<table width="100%">
												<tr>
													...
													<td width="20%" align="center">
														<a
															href="/xiaoyuanwang/album.do?flag=onePhotoUI&pid=xx&oid=xx&aid=xx&pageNo=1"
															style="border: 1px #D8DFEA solid;"
															onmouseover="chgImg(this)" onmouseout="chgImg2(this)"
															id="a x"> <img src="/xiaoyuanwang/images/${loginuser.id }/album/${photo.album.id }/${photo.photo}"
						...
						<td valign="top" align="center">
							<img src="/xiaoyuanwang/images/front/albumright.jpg" />
						</td>
					</tr>
				</table>
			</div>
