						...
						<td valign="top">
							<div class="divTbl">
								<table width="100%" border="0" cellspacing="1" cellpadding="10"
									...
									<tr>
										<td>
											<form action="/xiaoyuanwang/profile.do?flag=uploadPhoto" method="post"
												...
												<table width="100%" border="0" cellspacing="1"
													...
													<tr>
														<td valign="top">
															...
															<br />
															<img src="/xiaoyuanwang/images/${loginuser.id }/head/${loginuser.photo }?abc=<%=Math.random() %>" width="200"
																height="200" />
														</td>
														<td valign="top">
															&nbsp;
