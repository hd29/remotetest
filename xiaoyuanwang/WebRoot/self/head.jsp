...
-->
		...
		<div class="head">
			<img src="/xiaoyuanwang/images/front/top1.gif" width="713px" />
			<img src="/xiaoyuanwang/images/front/top2.jpg" width="280px" />
			<img src="/xiaoyuanwang/images/front/xnw3.jpg" style="float: left;" />
			<ul class="home_navi">
			<li onmouseover="changeBG(this)" onmouseout="changeBG2(this)"><a class="top" href="#">首页</a></li>
			<li onmouseover="changeBG(this)" onmouseout="changeBG2(this)"><a class="top" href="/xiaoyuanwang/profile.do?flag=goHomePageUI">个人主页</a></li>
			...
			<li>搜索</li>
			<li style="width: 170px;"><input type="text" /><img src="/xiaoyuanwang/images/front/sou.jpg" /></li>
			</ul>
			...
			<ul class="navi">
				...
				<li onmouseover="changeBG(this)" onmouseout="changeBG2(this)">
					<a  class="anavi" href="/xiaoyuanwang/login.do?flag=loginout">退出</a>
				</li>
			</ul>
		</div>
