...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<link rel="stylesheet" href="/xiaoyuanwang/css/css/homePage.css" type="text/css"></link>
		<link rel="stylesheet" href="/xiaoyuanwang/css/css/common.css" type="text/css"></link>
		<script type="text/javascript" src="/xiaoyuanwang/js/common.js"></script>
	...
	<body>
		...
		<div class="homePage">
			<div class="homePage_intro">
				...
				<table>
					...
					<tr>
						<td onMouseOver="chgTblusers(this)"
							...
							&nbsp;
							<a href="/xiaoyuanwang/profile.do?flag=goUploadPhotoUI" class="xh" id="editphotoa">更改我的头像</a>
						</td>
					</tr>
					<tr>
						<td onMouseOver="chgTblusers(this)"
				...
				<div class="allkinds">
					<img src="/xiaoyuanwang/images/front/profileleft.jpg" />
				</div>
			</div>
			<!-- 各种信息 -->
			<div class="profile">
				...
				<div class="curInfo">
					...
					<img src="/xiaoyuanwang/images/front/star.gif" />
					&nbsp;
				...
				<div class="opers">
					<table align="center" border="0" width="100%" cellspacing="1"
						...
						<tr>
							...
							<td class="feedsp" align="center">
								<a href="/xiaoyuanwang/album.do?flag=myAlbumUI" class="feed">相册</a>
							</td>
							<td class="feedsp" align="center">
							...
							<td>
								<a href="album.do?type=oneAlbum&oid=xx&pageNo=1&aid=xx"
									...
									onmouseout="chgImg2(this)" id="a100"> <img
										src="/xiaoyuanwang/images/photos/t4.jpg" width="100px" height="75px"
						...
						<tr>
							<td rowspan="2" width="8%">
								<a href="profile.do?type=feed&oid=xx"> <img
										src="/xiaoyuanwang/images/userhead/u1.gif" width="50px" height="50px" /> </a>
							</td>
							<td>
						...
						<tr>
							<td>
								<a href="profile.do?type=feed&oid=xxx"> <img
										src="/xiaoyuanwang/images/userhead/u1.gif" width="50px" height="50px" />
								</a>
							</td>
							<td>
