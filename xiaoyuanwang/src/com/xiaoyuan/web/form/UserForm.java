...
import com.xiaoyuan.domain.City;
import com.xiaoyuan.domain.Junior;
import com.xiaoyuan.domain.Primaryschool;
import com.xiaoyuan.domain.Province;
import com.xiaoyuan.domain.Techschool;

/** 
 * MyEclipse Struts
 * Creation date: 08-22-2015
 * 
 * XDoclet definition:
...
public class UserForm extends ActionForm {
	...
	private String universityId;//增加一个接收大学的id的字段
	
	private String userType; //增加一个用户类型的字段
	
	private FormFile myphoto;//增加一个头像 文件表单
